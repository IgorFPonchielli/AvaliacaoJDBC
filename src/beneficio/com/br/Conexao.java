...
import Classes.Desempregado;
import Classes.Empregado;
import Classes.Empregador;
...
public class Conexao {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				System.out.println("Data de Nascimento: " + resultSet.getString("dataNascimento"));
		...
		while (resposta.equals("sim")) {		
			try {
				...
				System.out.println("Beneficiario deletado com sucesso!");
			...
			System.out.println("\n\nVocê gostaria de deletar mais um beneficiário?");
			resposta = input.next();
		}
	...
	public static String InserirBeneficiario() {
		...
		case 1:
			...
			insert = "INSERT INTO BENEFICIARIOS (nome, dataNascimento, categoria, estado, aposentado, valorBeneficio) "
					+ "values ('" + empregado.getNomeCompleto() + "','" + empregado.getDataNascimento() + "',"
							+ "'" + empregado.getCategoria() + "', '"+ empregado.getEstado() +"', '" + empregado.isAposentado() + "',"
		...
		case 2:	
			...
			insert = "INSERT INTO BENEFICIARIOS (nome, dataNascimento, categoria, estado, qtdFuncionarios, valorBeneficio) "
					+ "values ('" + empregador.getNomeCompleto() + "','" + empregador.getDataNascimento() + "',"
					+ "'" + empregador.getCategoria() + "', '"+ empregador.getEstado() +"', '" + empregador.getQtdFuncionarios() + "',"
		...
		case 3:
			...
			insert = "INSERT INTO BENEFICIARIOS (nome, dataNascimento, categoria, estado, tempoDesemprego, valorBeneficio) "
					+ "values ('" + desempregado.getNomeCompleto() + "','" + desempregado.getDataNascimento() + "',"
					+ "'" + desempregado.getCategoria() + "', '"+ desempregado.getEstado() +"', '" + desempregado.getMesesDesempregado() + "',"
